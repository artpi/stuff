...
export class StuffApp extends HTMLElement {
  ...
  renderApplication() {
    ...
    const mobileHeader = element('header', { className: 'mobile-header' }, [
      element('a', { className: 'brand', href: this.collectionRoute({ searchQuery: '', placeId: '', tag: '', photo: 'all' }) }, [element('img', { src: 'assets/icons/icon.svg', alt: '' }), element('span', { text: 'stuff' })]),
